...
\begin{figure}[h!]
\centering
\subfloat[The model image]{\label{fig:pht_1}\includegraphics[width=0.45\textwidth]{./images/pht_1}}~~
\subfloat[The scene image ]{\label{fig:pht_2}\includegraphics[width=0.45\textwidth]{./images/pht_2}}
