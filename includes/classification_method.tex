...
Pre-processing is a process that reduces the noises of image and enhance the quality of image's features. To do that, the simplest method in segmentation, \textbf{threshold} method was used. In this case, the threshold value is important to apply this technique in pre-process image. The threshold value might indicated follows two ways: manually or automatically. In the concept of this report, we will introduce an method to indicate the threshold value by analysing the image histogram. This method will be focused in next chapter.
\begin{figure}[h!]
\centering
\subfloat[Image with noise]{\label{fig:seg_21}\includegraphics[width=0.45\textwidth]{./images/md019n}}~~
\subfloat[Image without noises]{\label{fig:seg_22}\includegraphics[width=0.45\textwidth]{./images/md019no}}
...
\begin{figure}[h!]
\centering
\subfloat[Original image]{\label{fig:seg_23}\includegraphics[width=0.45\textwidth]{./images/md019no}}~~
\subfloat[Image with line segmentation]{\label{fig:seg_24}\includegraphics[width=0.45\textwidth]{./images/md019seg}}
...
\begin{figure}[h!]
\centering
\subfloat[The geometric relationship between two lines]{\label{fig:25}\includegraphics[width=0.4\textwidth]{./images/PGH_geo}}~~
\subfloat[The pairwise geometric histogram ]{\label{fig:26}\includegraphics[width=0.4\textwidth]{./images/PGH}}
...
\begin{figure}[h!]
\centering
\subfloat[The model image]{\label{fig:27}
\includegraphics[width=0.4\textwidth]{./images/pht_1}}~~
\subfloat[The scene image ]{\label{fig:28}
...
Training process is process recording the relationship of model to a reference point in model. At this step, the perpendicular distance and angle from each pair model lines to a reference point (called reference table) was recording and saving. The reference point can be chosen at arbitrary position on the model image. 
