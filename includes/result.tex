...
{\label{fig:example_11}\includegraphics[width=0.45\textwidth]{./images/software}}~~
\subfloat[MAELab with Segmentation menu]
{\label{fig:example_12}\includegraphics[width=0.45\textwidth]{./images/newiface1}}\\
\subfloat[MAELab with Landmarks menu]{\label{fig:example_13}\includegraphics[width=0.45\textwidth]{./images/newiface2}}~~
\subfloat[MAELab with Utilities menu]
{\label{fig:example_14}\includegraphics[width=0.45\textwidth]{./images/newiface3}}
...
\subfloat[The scene image with estimated landmarks by cross-correlation ]{\label{fig:pht_2}\includegraphics[width=0.45\textwidth]{./images/md32_cross}}~~
\subfloat[The scene image with estimated landmarks (by article) ]{\label{fig:pht_2}\includegraphics[width=0.45\textwidth]{./images/est32}}
